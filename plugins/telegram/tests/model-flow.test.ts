...
// alias charset validation, keyboard shape, and the admin gate. The actual tmux
// injection (handleModelSwitch → operator-model-inject.sh) is exercised separately
// via the script's own DRY-RUN; not unit-tested here (shells out to live tmux).
